...
countrydf <- filter(countrydf, country==country.name)

ggplot(countrydf, aes(x=name, y=country_score)) + geom_bar(stat="identity") + theme(axis.text.x = element_text(angle = 90, hjust = 1)) + scale_x_discrete(country.name)
}
